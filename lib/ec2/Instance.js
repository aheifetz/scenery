...
Instance.prototype.publicIP = function(subnetId, GroupSet){
    if( !this.node.Properties.NetworkInterfaces){
...
Instance.prototype.DockerUserInit = function(){
     var userData =  {'Fn::Base64': { 'Fn::Join': ['',[ 
                            '#!/bin/bash -ex\n',  
                            'yum update -y \n',
...
// -- ResourceOutputs -- //
///////////////////////////////////////////////////
Instance.prototype.getPublicIP = function(){
...
Instance.prototype.getPrivateIP = function(){
